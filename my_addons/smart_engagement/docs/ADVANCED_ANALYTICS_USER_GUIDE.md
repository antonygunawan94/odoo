...
This comprehensive guide covers all advanced analytics features in the Smart Engagement module, including engagement scoring, churn prediction, cohort analysis, product category analytics, and emerging trends like social commerce and BNPL analytics.
...
The Smart Engagement module now includes cutting-edge customer analytics capabilities that go far beyond traditional RFM analysis. These features help you understand your customers at a deeper level and create more effective marketing campaigns.
...
1. Navigate to **Smart Engagement > Reports > Cohort Analysis**
...
Navigate to **Smart Engagement > Reports > Category Performance**:
...
- Navigate to: **Smart Engagement > Configuration > Customer Spending Tiers**
...
- Navigate to: **Smart Engagement > Configuration > Customer Age Groups**
...
- Navigate to: **Smart Engagement > Configuration > Customer Acquisition Sources**
- Configure: Source names, codes, and categories
- Track custom channels specific to your business

**4. Analytics Package Settings**
- Navigate to: **Settings > Smart Engagement > Analytics Configuration**
