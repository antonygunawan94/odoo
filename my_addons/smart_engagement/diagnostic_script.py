...
def diagnose_dashboard_issues(env):
    ...
    try:
        ...
        env.cr.execute("""
            ...
            WHERE table_name = 'smart_engagement_top_products_by_category_report'
        """)
...
2. In the shell, run:
   exec(open('/mnt/c/Users/anton/labs/odoo/odoo/my_addons/smart_engagement/diagnostic_script.py').read())
