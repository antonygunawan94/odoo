...
### 📍 Navigation Path
**Path:** `WhatsApp Marketing Automation → Configuration → Customer Age Groups`
...
#### B. Customer Reports
**Path:** `WhatsApp Marketing → Reports → Customer Demographics`
...
**Path:** `WhatsApp Marketing → Reports → Product Category Performance`
