# WhatsApp Marketing Automation - Quick Start Guide
...
1. **Navigate to Configuration**
   ...
   - Go to: **WhatsApp Marketing Automation → Configuration**
...
1. **Navigate to Segmentation**
   ...
   - Go to: **WhatsApp Marketing Automation → Customer Segmentations**
...
1. **Navigate to Campaigns**
   ...
   - Go to: **WhatsApp Marketing Automation → Campaigns**
...
2. **Monitor Progress**
   - Go to: **WhatsApp Marketing Automation → WhatsApp API Logs**
...
- Navigate to **WhatsApp Marketing Automation → Customer Segmentations**
